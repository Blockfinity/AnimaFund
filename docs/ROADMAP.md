...
|---|---|---|---|---|
| 1.1 | Create new directory structure | Current messy repo | platform/, api/, engine/, ultimus/, archive/, docs/ | None |
| 1.2 | Move dashboard files | frontend/ | platform/ | 1.1 |
| 1.3 | Move API files, archive bloat | backend/ | api/ + archive/ | 1.1 |
| 1.4 | Move skills + templates | automaton/skills/, genesis-prompt.md, constitution.md | engine/skills/, engine/templates/ | 1.1 |
| 1.5 | Delete Conway fork | automaton/dist, native, node_modules, src, packages | 543MB freed | 1.1 |
| 1.6 | Delete dead code | engine_bridge.py, payment_tracker.py, webhook_daemon_template.py | 1,322 lines removed | 1.1 |
| 1.7 | Update supervisor + imports | Old paths | New paths working | 1.2, 1.3 |
...
- Phase 1: `platform/` loads, `api/` responds, repo is clean, old bloat deleted
