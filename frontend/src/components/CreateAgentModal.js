      ...
      <div data-testid="create-agent-modal" className="bg-white rounded-lg border border-border w-full max-w-2xl shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <input
              data-testid="agent-welcome-input"
          ...
          <div>
            ...
            <textarea
              ...
              rows={10}
              className="w-full px-3 py-2 text-sm border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-foreground font-mono resize-y"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              data-testid="agent-goals-input"
              value={goals} onChange={(e) => setGoals(e.target.value)}
              placeholder={"Make $5K in the first hour\nInstall OpenClaw and expand capabilities\nFind and partner with 3 AI agents"}
              rows={4}
              className="w-full px-3 py-2 text-sm border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-foreground resize-y"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                data-testid="agent-sol-wallet-input"
                value={solWallet} onChange={(e) => setSolWallet(e.target.value)}
                placeholder="Solana address..."
                className="w-full px-3 py-2 text-xs border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-foreground font-mono"
              />
            </div>
            <div>
              <label className="text-[10px] uppercase tracking-wider text-muted-foreground font-medium block mb-1">Creator ETH Wallet</label>
              <input
                data-testid="agent-eth-wallet-input"
                value={ethWallet} onChange={(e) => setEthWallet(e.target.value)}
          ...
          <div>
            ...
            <input
              data-testid="agent-revenue-share-input"
