...
import {
  ...
  CheckCircle2, XCircle, MessageSquare, Shield, Zap, Send,
  ChevronDown, Globe, Cpu, Wallet, ExternalLink, Network,
  FolderOpen, HardDrive, Trash2, Radio
} from 'lucide-react';
...
const SECTIONS = [
  ...
  },
  {
    title: 'Launch',
    items: [
      { id: 'nudge', label: 'Go Autonomous', desc: 'Tell the agent all tools are ready — zero control after this', action: '/api/provision/nudge', icon: Zap, needs: null },
    ],
  },
];
