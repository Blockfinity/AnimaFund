 ...
 * Skills Loader
 *
 * Discovers and loads SKILL.md files from ~/.anima/skills/
 ...
 */
export function loadSkills(skillsDir, db) {
 ...
 */
function validateInstructionContent(instructions, skillName) {
 ...
 */
export function getActiveSkillInstructions(skills) {
