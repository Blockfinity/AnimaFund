/**
 * Anima Fund Configuration
 *
 * Loads and saves the fund agent's configuration from ~/.anima/automaton.json
 */
import fs from "fs";
...
export function createConfig(params) {
    return {
        ...
        heartbeatConfigPath: DEFAULT_CONFIG.heartbeatConfigPath || "~/.anima/heartbeat.yml",
        dbPath: DEFAULT_CONFIG.dbPath || "~/.anima/state.db",
        logLevel: DEFAULT_CONFIG.logLevel || "info",
        walletAddress: params.walletAddress,
        version: DEFAULT_CONFIG.version || "0.2.1",
        skillsDir: DEFAULT_CONFIG.skillsDir || "~/.anima/skills",
